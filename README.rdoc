...
RGeoServer is a Ruby client for GeoServer's REST catalog interfaces, and provides a
Rails model abstraction for GeoServer resources.

Requirements:
* Ruby 1.9.3
* ActiveResource
* {GeoServer}[http://geoserver.org] 2.3 or later.
...
* {GeoServer}[http://geoserver.org]
  ...
  * {REST Configuration API Reference}[http://docs.geoserver.org/stable/en/user/rest/index.html]
...
- <b>v0.7</b> - Major rewrite to use ActiveResource as platform
- <b>v0.6</b> - Major update with keywords, YAML config, REST API, unit testing and cleanup
